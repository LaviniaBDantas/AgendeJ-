                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="medicoEspecialista.php?especialidade=Cardiologia" class="btn btn-primary">Ver mais </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="medicoEspecialista.php?especialidade=Dermatologia" class="btn btn-primary">Ver mais </a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
