...
<body>
    ...
    <section class="about-section">
        <div class="container">
            ...
            <p class="lead">
                O <strong>Agende Já</strong> é uma plataforma dedicada a conectar pacientes aos melhores profissionais de saúde. 
                Nosso objetivo é facilitar o agendamento de consultas, proporcionando uma experiência simples, rápida e segura. 
                Acreditamos que a saúde é um direito de todos, e estamos aqui para ajudar você a cuidar do que mais importa.
            </p>
        </div>
    </section>
